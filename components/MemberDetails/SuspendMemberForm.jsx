...
const SuspendMemberForm = ({
  ...
  const intialFields = [
    ...
    },
    {
      ...
      dataType: "text",
      comboOptions: [
        { code: "موقوف", name: "إيقاف" },
        { code: "-", name: "إلغاء الإيقاف" },
      ],
      required: true,
    },
    {
  ...
  const handleFileChange = (event) => {
    setFieldsValues({ ...fieldsValus, [event.target.id]: event.target.value });
  ...
  const formik = useFormik({
    ...
    onSubmit: async (data) => {
      ...
      submit(table, method, data, utils);
    },
  });
...
export default SuspendMemberForm;
