...
import ReportExcel from "./ReportExcel.jsx";
...
const LazyTable = ({
  ...
  const loadLazyData = async () => {
    ...
    // let currentDate = localStorage.getItem("filterDate");
    // if (currentDate)
    // currentDate =  localStorage.getItem("filterDate") 
    // else localStorage.setItem("filterDate", new Date())
            ...
            return (
              <Calendar
                ...
                onChange={(e) => {
                  ...
                  localStorage.setItem("filterDate", e.value)
                }}
                // dateFormat="dd/mm/yy"
                dateFormat="dd/mm/yy"
              />
